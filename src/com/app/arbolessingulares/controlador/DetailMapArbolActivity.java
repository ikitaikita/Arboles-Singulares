...
import com.arbolessingulares.directions.route.Routing;
import com.arbolessingulares.directions.route.Routing.TravelMode;
import com.arbolessingulares.directions.route.RoutingListener;
...
/**
 * Clase para representar el punto de localizacion del arbol en el mapa.
 * Extiende de CustomMapActivity
 * @see es.queaplicacion.quebar.CustomMapActivity
 * @version 1.0
 * @author Victoria Marcos
 */
public class DetailMapArbolActivity extends  android.support.v4.app.FragmentActivity  implements RoutingListener {
	...
	protected void onCreate(Bundle arg0) {
		...
		setContentView(R.layout.detail_maparbol_layout);	
		...
		positionFinal = new LatLng(Double.parseDouble(mArbol.getLatitud()),Double.parseDouble( mArbol.getLongitud()));
		...
		descrip =  "Altura: " + mArbol.getAltura() + " m";
		title = mArbol.getNombre();
		...
		gotoDetail.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(getApplicationContext(),DetailArbolActivity.class);
